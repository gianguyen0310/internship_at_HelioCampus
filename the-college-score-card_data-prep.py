...
for filename in institution_level_files:
    ...
    temp_df = pd.read_csv(filename, low_memory=False, index_col=False, usecols=columns_to_read_list, na_values= ['NULL','PrivacySuppressed'],
                          dtype={'ACAD_YR': str, 'UNITID': str, 'OPEID': str, 'OPEID6': str, 'INSTNM': str, 'CITY': str, 'STABBR': str, 'ZIP': str, 'ACCREDAGENCY': str,
                                ...
                                'PFTFAC': float, 'PCTPELL': float, 'C150_4': float, 'C150_L4': float, 'C150_4_POOLED': float, 'C150_L4_POOLED': float, 'POOLYRS': 'Int64', 'PFTFTUG1_EF': float, 'C150_4_WHITE': float, 'C150_4_BLACK': float, 'C150_4_HISP': float, 'C150_4_ASIAN': float, 'C150_4_AIAN': float, 'C150_4_NHPI': float, 'C150_4_2MOR': float, 'C150_4_NRA': float, 'C150_4_UNKN': float, 'C150_4_WHITENH': float, 'C150_4_BLACKNH': float, 'C150_4_API': float, 'C150_4_AIANOLD': float, 'C150_4_HISPOLD': float, 'C150_L4_WHITE': float, 'C150_L4_BLACK': float, 'C150_L4_HISP': float, 'C150_L4_ASIAN': float, 'C150_L4_AIAN': float, 'C150_L4_NHPI': float, 'C150_L4_2MOR': float, 'C150_L4_NRA': float, 'C150_L4_UNKN': float, 'C150_L4_WHITENH': float, 'C150_L4_BLACKNH': float, 'C150_L4_API': float, 'C150_L4_AIANOLD': float, 'C150_L4_HISPOLD': float, 'C200_4': float, 'C200_L4': float, 'D200_4': float, 'D200_L4': float, 'RET_FT4': float, 'RET_FTL4': float, 'RET_PT4': float, 'RET_PTL4': float, 'C200_4_POOLED': float, 'C200_L4_POOLED': float, 'POOLYRS200': 'Int64', 'PCTFLOAN': float, 'UG25ABV': float, 'CDR2': float, 'CDR3': float, 'DEATH_YR2_RT': float, 'COMP_ORIG_YR2_RT': float, 'COMP_4YR_TRANS_YR2_RT': float, 'COMP_2YR_TRANS_YR2_RT': float, 'WDRAW_ORIG_YR2_RT': float, 'WDRAW_4YR_TRANS_YR2_RT': float, 'WDRAW_2YR_TRANS_YR2_RT': float, 'ENRL_ORIG_YR2_RT': float, 'ENRL_4YR_TRANS_YR2_RT': float, 'ENRL_2YR_TRANS_YR2_RT': float, 'UNKN_ORIG_YR2_RT': float, 'UNKN_4YR_TRANS_YR2_RT': float, 'UNKN_2YR_TRANS_YR2_RT': float, 'LO_INC_DEATH_YR2_RT': float, 'LO_INC_COMP_ORIG_YR2_RT': float, 'LO_INC_COMP_4YR_TRANS_YR2_RT': float, 'LO_INC_COMP_2YR_TRANS_YR2_RT': float, 'LO_INC_WDRAW_ORIG_YR2_RT': float, 'LO_INC_WDRAW_4YR_TRANS_YR2_RT': float, 'LO_INC_WDRAW_2YR_TRANS_YR2_RT': float, 'LO_INC_ENRL_ORIG_YR2_RT': float, 'LO_INC_ENRL_4YR_TRANS_YR2_RT': float, 'LO_INC_ENRL_2YR_TRANS_YR2_RT': float, 'LO_INC_UNKN_ORIG_YR2_RT': float, 'LO_INC_UNKN_4YR_TRANS_YR2_RT': float, 'LO_INC_UNKN_2YR_TRANS_YR2_RT': float, 'MD_INC_DEATH_YR2_RT': float, 'MD_INC_COMP_ORIG_YR2_RT': float, 'MD_INC_COMP_4YR_TRANS_YR2_RT': float, 'MD_INC_COMP_2YR_TRANS_YR2_RT': float, 'MD_INC_WDRAW_ORIG_YR2_RT': float, 'MD_INC_WDRAW_4YR_TRANS_YR2_RT': float, 'MD_INC_WDRAW_2YR_TRANS_YR2_RT': float, 'MD_INC_ENRL_ORIG_YR2_RT': float, 'MD_INC_ENRL_4YR_TRANS_YR2_RT': float, 'MD_INC_ENRL_2YR_TRANS_YR2_RT': float, 'MD_INC_UNKN_ORIG_YR2_RT': float, 'MD_INC_UNKN_4YR_TRANS_YR2_RT': float, 'MD_INC_UNKN_2YR_TRANS_YR2_RT': float, 'HI_INC_DEATH_YR2_RT': float, 'HI_INC_COMP_ORIG_YR2_RT': float, 'HI_INC_COMP_4YR_TRANS_YR2_RT': float, 'HI_INC_COMP_2YR_TRANS_YR2_RT': float, 'HI_INC_WDRAW_ORIG_YR2_RT': float, 'HI_INC_WDRAW_4YR_TRANS_YR2_RT': float, 'HI_INC_WDRAW_2YR_TRANS_YR2_RT': float, 'HI_INC_ENRL_ORIG_YR2_RT': float, 'HI_INC_ENRL_4YR_TRANS_YR2_RT': float, 'HI_INC_ENRL_2YR_TRANS_YR2_RT': float, 'HI_INC_UNKN_ORIG_YR2_RT': float, 'HI_INC_UNKN_4YR_TRANS_YR2_RT': float, 'HI_INC_UNKN_2YR_TRANS_YR2_RT': float, 'DEP_DEATH_YR2_RT': float, 'DEP_COMP_ORIG_YR2_RT': float, 'DEP_COMP_4YR_TRANS_YR2_RT': float, 'DEP_COMP_2YR_TRANS_YR2_RT': float, 'DEP_WDRAW_ORIG_YR2_RT': float, 'DEP_WDRAW_4YR_TRANS_YR2_RT': float, 'DEP_WDRAW_2YR_TRANS_YR2_RT': float, 'DEP_ENRL_ORIG_YR2_RT': float, 'DEP_ENRL_4YR_TRANS_YR2_RT': float, 'DEP_ENRL_2YR_TRANS_YR2_RT': float, 'DEP_UNKN_ORIG_YR2_RT': float, 'DEP_UNKN_4YR_TRANS_YR2_RT': float, 'DEP_UNKN_2YR_TRANS_YR2_RT': float, 'IND_DEATH_YR2_RT': float, 'IND_COMP_ORIG_YR2_RT': float, 'IND_COMP_4YR_TRANS_YR2_RT': float, 'IND_COMP_2YR_TRANS_YR2_RT': float, 'IND_WDRAW_ORIG_YR2_RT': float, 'IND_WDRAW_4YR_TRANS_YR2_RT': float, 'IND_WDRAW_2YR_TRANS_YR2_RT': float, 'IND_ENRL_ORIG_YR2_RT': float, 'IND_ENRL_4YR_TRANS_YR2_RT': float, 'IND_ENRL_2YR_TRANS_YR2_RT': float, 'IND_UNKN_ORIG_YR2_RT': float, 'IND_UNKN_4YR_TRANS_YR2_RT': float, 'IND_UNKN_2YR_TRANS_YR2_RT': float, 'FEMALE_DEATH_YR2_RT': float, 'FEMALE_COMP_ORIG_YR2_RT': float, 'FEMALE_COMP_4YR_TRANS_YR2_RT': float, 'FEMALE_COMP_2YR_TRANS_YR2_RT': float, 'FEMALE_WDRAW_ORIG_YR2_RT': float, 'FEMALE_WDRAW_4YR_TRANS_YR2_RT': float, 'FEMALE_WDRAW_2YR_TRANS_YR2_RT': float, 'FEMALE_ENRL_ORIG_YR2_RT': float, 'FEMALE_ENRL_4YR_TRANS_YR2_RT': float, 'FEMALE_ENRL_2YR_TRANS_YR2_RT': float, 'FEMALE_UNKN_ORIG_YR2_RT': float, 'FEMALE_UNKN_4YR_TRANS_YR2_RT': float, 'FEMALE_UNKN_2YR_TRANS_YR2_RT': float, 'MALE_DEATH_YR2_RT': float, 'MALE_COMP_ORIG_YR2_RT': float, 'MALE_COMP_4YR_TRANS_YR2_RT': float, 'MALE_COMP_2YR_TRANS_YR2_RT': float, 'MALE_WDRAW_ORIG_YR2_RT': float, 'MALE_WDRAW_4YR_TRANS_YR2_RT': float, 'MALE_WDRAW_2YR_TRANS_YR2_RT': float, 'MALE_ENRL_ORIG_YR2_RT': float, 'MALE_ENRL_4YR_TRANS_YR2_RT': float, 'MALE_ENRL_2YR_TRANS_YR2_RT': float, 'MALE_UNKN_ORIG_YR2_RT': float, 'MALE_UNKN_4YR_TRANS_YR2_RT': float, 'MALE_UNKN_2YR_TRANS_YR2_RT': float, 'PELL_DEATH_YR2_RT': float, 'PELL_COMP_ORIG_YR2_RT': float, 'PELL_COMP_4YR_TRANS_YR2_RT': float, 'PELL_COMP_2YR_TRANS_YR2_RT': float, 'PELL_WDRAW_ORIG_YR2_RT': float, 'PELL_WDRAW_4YR_TRANS_YR2_RT': float, 'PELL_WDRAW_2YR_TRANS_YR2_RT': float, 'PELL_ENRL_ORIG_YR2_RT': float, 'PELL_ENRL_4YR_TRANS_YR2_RT': float, 'PELL_ENRL_2YR_TRANS_YR2_RT': float, 'PELL_UNKN_ORIG_YR2_RT': float, 'PELL_UNKN_4YR_TRANS_YR2_RT': float, 'PELL_UNKN_2YR_TRANS_YR2_RT': float, 'NOPELL_DEATH_YR2_RT': float, 'NOPELL_COMP_ORIG_YR2_RT': float, 'NOPELL_COMP_4YR_TRANS_YR2_RT': float, 'NOPELL_COMP_2YR_TRANS_YR2_RT': float, 'NOPELL_WDRAW_ORIG_YR2_RT': float, 'NOPELL_WDRAW_4YR_TRANS_YR2_RT': float, 'NOPELL_WDRAW_2YR_TRANS_YR2_RT': float, 'NOPELL_ENRL_ORIG_YR2_RT': float, 'NOPELL_ENRL_4YR_TRANS_YR2_RT': float, 'NOPELL_ENRL_2YR_TRANS_YR2_RT': float, 'NOPELL_UNKN_ORIG_YR2_RT': float, 'NOPELL_UNKN_4YR_TRANS_YR2_RT': float, 'NOPELL_UNKN_2YR_TRANS_YR2_RT': float, 'FIRSTGEN_DEATH_YR2_RT': float, 'FIRSTGEN_COMP_ORIG_YR2_RT': float, 'FIRSTGEN_COMP_4YR_TRANS_YR2_RT': float, 'FIRSTGEN_COMP_2YR_TRANS_YR2_RT': float, 'FIRSTGEN_WDRAW_ORIG_YR2_RT': float, 'FIRSTGEN_WDRAW_4YR_TRANS_YR2_RT': float, 'FIRSTGEN_WDRAW_2YR_TRANS_YR2_RT': float, 'FIRSTGEN_ENRL_ORIG_YR2_RT': float, 'FIRSTGEN_ENRL_4YR_TRANS_YR2_RT': float, 'FIRSTGEN_ENRL_2YR_TRANS_YR2_RT': float, 'FIRSTGEN_UNKN_ORIG_YR2_RT': float, 'FIRSTGEN_UNKN_4YR_TRANS_YR2_RT': float, 'FIRSTGEN_UNKN_2YR_TRANS_YR2_RT': float, 'NOT1STGEN_DEATH_YR2_RT': float, 'NOT1STGEN_COMP_ORIG_YR2_RT': float, 'NOT1STGEN_COMP_4YR_TRANS_YR2_RT': float, 'NOT1STGEN_COMP_2YR_TRANS_YR2_RT': float, 'NOT1STGEN_WDRAW_ORIG_YR2_RT': float, 'NOT1STGEN_WDRAW_4YR_TRANS_YR2_RT': float, 'NOT1STGEN_WDRAW_2YR_TRANS_YR2_RT': float, 'NOT1STGEN_ENRL_ORIG_YR2_RT': float, 'NOT1STGEN_ENRL_4YR_TRANS_YR2_RT': float, 'NOT1STGEN_ENRL_2YR_TRANS_YR2_RT': float, 'NOT1STGEN_UNKN_ORIG_YR2_RT': float, 'NOT1STGEN_UNKN_4YR_TRANS_YR2_RT': float, 'NOT1STGEN_UNKN_2YR_TRANS_YR2_RT': float, 'DEATH_YR3_RT': float, 'COMP_ORIG_YR3_RT': float, 'COMP_4YR_TRANS_YR3_RT': float, 'COMP_2YR_TRANS_YR3_RT': float, 'WDRAW_ORIG_YR3_RT': float, 'WDRAW_4YR_TRANS_YR3_RT': float, 'WDRAW_2YR_TRANS_YR3_RT': float, 'ENRL_ORIG_YR3_RT': float, 'ENRL_4YR_TRANS_YR3_RT': float, 'ENRL_2YR_TRANS_YR3_RT': float, 'UNKN_ORIG_YR3_RT': float, 'UNKN_4YR_TRANS_YR3_RT': float, 'UNKN_2YR_TRANS_YR3_RT': float, 'LO_INC_DEATH_YR3_RT': float, 'LO_INC_COMP_ORIG_YR3_RT': float, 'LO_INC_COMP_4YR_TRANS_YR3_RT': float, 'LO_INC_COMP_2YR_TRANS_YR3_RT': float, 'LO_INC_WDRAW_ORIG_YR3_RT': float, 'LO_INC_WDRAW_4YR_TRANS_YR3_RT': float, 'LO_INC_WDRAW_2YR_TRANS_YR3_RT': float, 'LO_INC_ENRL_ORIG_YR3_RT': float, 'LO_INC_ENRL_4YR_TRANS_YR3_RT': float, 'LO_INC_ENRL_2YR_TRANS_YR3_RT': float, 'LO_INC_UNKN_ORIG_YR3_RT': float, 'LO_INC_UNKN_4YR_TRANS_YR3_RT': float, 'LO_INC_UNKN_2YR_TRANS_YR3_RT': float, 'MD_INC_DEATH_YR3_RT': float, 'MD_INC_COMP_ORIG_YR3_RT': float, 'MD_INC_COMP_4YR_TRANS_YR3_RT': float, 'MD_INC_COMP_2YR_TRANS_YR3_RT': float, 'MD_INC_WDRAW_ORIG_YR3_RT': float, 'MD_INC_WDRAW_4YR_TRANS_YR3_RT': float, 'MD_INC_WDRAW_2YR_TRANS_YR3_RT': float, 'MD_INC_ENRL_ORIG_YR3_RT': float, 'MD_INC_ENRL_4YR_TRANS_YR3_RT': float, 'MD_INC_ENRL_2YR_TRANS_YR3_RT': float, 'MD_INC_UNKN_ORIG_YR3_RT': float, 'MD_INC_UNKN_4YR_TRANS_YR3_RT': float, 'MD_INC_UNKN_2YR_TRANS_YR3_RT': float, 'HI_INC_DEATH_YR3_RT': float, 'HI_INC_COMP_ORIG_YR3_RT': float, 'HI_INC_COMP_4YR_TRANS_YR3_RT': float, 'HI_INC_COMP_2YR_TRANS_YR3_RT': float, 'HI_INC_WDRAW_ORIG_YR3_RT': float, 'HI_INC_WDRAW_4YR_TRANS_YR3_RT': float, 'HI_INC_WDRAW_2YR_TRANS_YR3_RT': float, 'HI_INC_ENRL_ORIG_YR3_RT': float, 'HI_INC_ENRL_4YR_TRANS_YR3_RT': float, 'HI_INC_ENRL_2YR_TRANS_YR3_RT': float, 'HI_INC_UNKN_ORIG_YR3_RT': float, 'HI_INC_UNKN_4YR_TRANS_YR3_RT': float, 'HI_INC_UNKN_2YR_TRANS_YR3_RT': float, 'DEP_DEATH_YR3_RT': float, 'DEP_COMP_ORIG_YR3_RT': float, 'DEP_COMP_4YR_TRANS_YR3_RT': float, 'DEP_COMP_2YR_TRANS_YR3_RT': float, 'DEP_WDRAW_ORIG_YR3_RT': float, 'DEP_WDRAW_4YR_TRANS_YR3_RT': float, 'DEP_WDRAW_2YR_TRANS_YR3_RT': float, 'DEP_ENRL_ORIG_YR3_RT': float, 'DEP_ENRL_4YR_TRANS_YR3_RT': float, 'DEP_ENRL_2YR_TRANS_YR3_RT': float, 'DEP_UNKN_ORIG_YR3_RT': float, 'DEP_UNKN_4YR_TRANS_YR3_RT': float, 'DEP_UNKN_2YR_TRANS_YR3_RT': float, 'IND_DEATH_YR3_RT': float, 'IND_COMP_ORIG_YR3_RT': float, 'IND_COMP_4YR_TRANS_YR3_RT': float, 'IND_COMP_2YR_TRANS_YR3_RT': float, 'IND_WDRAW_ORIG_YR3_RT': float, 'IND_WDRAW_4YR_TRANS_YR3_RT': float, 'IND_WDRAW_2YR_TRANS_YR3_RT': float, 'IND_ENRL_ORIG_YR3_RT': float, 'IND_ENRL_4YR_TRANS_YR3_RT': float, 'IND_ENRL_2YR_TRANS_YR3_RT': float, 'IND_UNKN_ORIG_YR3_RT': float, 'IND_UNKN_4YR_TRANS_YR3_RT': float, 'IND_UNKN_2YR_TRANS_YR3_RT': float, 'FEMALE_DEATH_YR3_RT': float, 'FEMALE_COMP_ORIG_YR3_RT': float, 'FEMALE_COMP_4YR_TRANS_YR3_RT': float, 'FEMALE_COMP_2YR_TRANS_YR3_RT': float, 'FEMALE_WDRAW_ORIG_YR3_RT': float, 'FEMALE_WDRAW_4YR_TRANS_YR3_RT': float, 'FEMALE_WDRAW_2YR_TRANS_YR3_RT': float, 'FEMALE_ENRL_ORIG_YR3_RT': float, 'FEMALE_ENRL_4YR_TRANS_YR3_RT': float, 'FEMALE_ENRL_2YR_TRANS_YR3_RT': float, 'FEMALE_UNKN_ORIG_YR3_RT': float, 'FEMALE_UNKN_4YR_TRANS_YR3_RT': float, 'FEMALE_UNKN_2YR_TRANS_YR3_RT': float, 'MALE_DEATH_YR3_RT': float, 'MALE_COMP_ORIG_YR3_RT': float, 'MALE_COMP_4YR_TRANS_YR3_RT': float, 'MALE_COMP_2YR_TRANS_YR3_RT': float, 'MALE_WDRAW_ORIG_YR3_RT': float, 'MALE_WDRAW_4YR_TRANS_YR3_RT': float, 'MALE_WDRAW_2YR_TRANS_YR3_RT': float, 'MALE_ENRL_ORIG_YR3_RT': float, 'MALE_ENRL_4YR_TRANS_YR3_RT': float, 'MALE_ENRL_2YR_TRANS_YR3_RT': float, 'MALE_UNKN_ORIG_YR3_RT': float, 'MALE_UNKN_4YR_TRANS_YR3_RT': float, 'MALE_UNKN_2YR_TRANS_YR3_RT': float, 'PELL_DEATH_YR3_RT': float, 'PELL_COMP_ORIG_YR3_RT': float, 'PELL_COMP_4YR_TRANS_YR3_RT': float, 'PELL_COMP_2YR_TRANS_YR3_RT': float, 'PELL_WDRAW_ORIG_YR3_RT': float, 'PELL_WDRAW_4YR_TRANS_YR3_RT': float, 'PELL_WDRAW_2YR_TRANS_YR3_RT': float, 'PELL_ENRL_ORIG_YR3_RT': float, 'PELL_ENRL_4YR_TRANS_YR3_RT': float, 'PELL_ENRL_2YR_TRANS_YR3_RT': float, 'PELL_UNKN_ORIG_YR3_RT': float, 'PELL_UNKN_4YR_TRANS_YR3_RT': float, 'PELL_UNKN_2YR_TRANS_YR3_RT': float, 'NOPELL_DEATH_YR3_RT': float, 'NOPELL_COMP_ORIG_YR3_RT': float, 'NOPELL_COMP_4YR_TRANS_YR3_RT': float, 'NOPELL_COMP_2YR_TRANS_YR3_RT': float, 'NOPELL_WDRAW_ORIG_YR3_RT': float, 'NOPELL_WDRAW_4YR_TRANS_YR3_RT': float, 'NOPELL_WDRAW_2YR_TRANS_YR3_RT': float, 'NOPELL_ENRL_ORIG_YR3_RT': float, 'NOPELL_ENRL_4YR_TRANS_YR3_RT': float, 'NOPELL_ENRL_2YR_TRANS_YR3_RT': float, 'NOPELL_UNKN_ORIG_YR3_RT': float, 'NOPELL_UNKN_4YR_TRANS_YR3_RT': float, 'NOPELL_UNKN_2YR_TRANS_YR3_RT': float, 'FIRSTGEN_DEATH_YR3_RT': float, 'FIRSTGEN_COMP_ORIG_YR3_RT': float, 'FIRSTGEN_COMP_4YR_TRANS_YR3_RT': float, 'FIRSTGEN_COMP_2YR_TRANS_YR3_RT': float, 'FIRSTGEN_WDRAW_ORIG_YR3_RT': float, 'FIRSTGEN_WDRAW_4YR_TRANS_YR3_RT': float, 'FIRSTGEN_WDRAW_2YR_TRANS_YR3_RT': float, 'FIRSTGEN_ENRL_ORIG_YR3_RT': float, 'FIRSTGEN_ENRL_4YR_TRANS_YR3_RT': float, 'FIRSTGEN_ENRL_2YR_TRANS_YR3_RT': float, 'FIRSTGEN_UNKN_ORIG_YR3_RT': float, 'FIRSTGEN_UNKN_4YR_TRANS_YR3_RT': float, 'FIRSTGEN_UNKN_2YR_TRANS_YR3_RT': float, 'NOT1STGEN_DEATH_YR3_RT': float, 'NOT1STGEN_COMP_ORIG_YR3_RT': float, 'NOT1STGEN_COMP_4YR_TRANS_YR3_RT': float, 'NOT1STGEN_COMP_2YR_TRANS_YR3_RT': float, 'NOT1STGEN_WDRAW_ORIG_YR3_RT': float, 'NOT1STGEN_WDRAW_4YR_TRANS_YR3_RT': float, 'NOT1STGEN_WDRAW_2YR_TRANS_YR3_RT': float, 'NOT1STGEN_ENRL_ORIG_YR3_RT': float, 'NOT1STGEN_ENRL_4YR_TRANS_YR3_RT': float, 'NOT1STGEN_ENRL_2YR_TRANS_YR3_RT': float, 'NOT1STGEN_UNKN_ORIG_YR3_RT': float, 'NOT1STGEN_UNKN_4YR_TRANS_YR3_RT': float, 'NOT1STGEN_UNKN_2YR_TRANS_YR3_RT': float, 'DEATH_YR4_RT': float, 'COMP_ORIG_YR4_RT': float, 'COMP_4YR_TRANS_YR4_RT': float, 'COMP_2YR_TRANS_YR4_RT': float, 'WDRAW_ORIG_YR4_RT': float, 'WDRAW_4YR_TRANS_YR4_RT': float, 'WDRAW_2YR_TRANS_YR4_RT': float, 'ENRL_ORIG_YR4_RT': float, 'ENRL_4YR_TRANS_YR4_RT': float, 'ENRL_2YR_TRANS_YR4_RT': float, 'UNKN_ORIG_YR4_RT': float, 'UNKN_4YR_TRANS_YR4_RT': float, 'UNKN_2YR_TRANS_YR4_RT': float, 'LO_INC_DEATH_YR4_RT': float, 'LO_INC_COMP_ORIG_YR4_RT': float, 'LO_INC_COMP_4YR_TRANS_YR4_RT': float, 'LO_INC_COMP_2YR_TRANS_YR4_RT': float, 'LO_INC_WDRAW_ORIG_YR4_RT': float, 'LO_INC_WDRAW_4YR_TRANS_YR4_RT': float, 'LO_INC_WDRAW_2YR_TRANS_YR4_RT': float, 'LO_INC_ENRL_ORIG_YR4_RT': float, 'LO_INC_ENRL_4YR_TRANS_YR4_RT': float, 'LO_INC_ENRL_2YR_TRANS_YR4_RT': float, 'LO_INC_UNKN_ORIG_YR4_RT': float, 'LO_INC_UNKN_4YR_TRANS_YR4_RT': float, 'LO_INC_UNKN_2YR_TRANS_YR4_RT': float, 'MD_INC_DEATH_YR4_RT': float, 'MD_INC_COMP_ORIG_YR4_RT': float, 'MD_INC_COMP_4YR_TRANS_YR4_RT': float, 'MD_INC_COMP_2YR_TRANS_YR4_RT': float, 'MD_INC_WDRAW_ORIG_YR4_RT': float, 'MD_INC_WDRAW_4YR_TRANS_YR4_RT': float, 'MD_INC_WDRAW_2YR_TRANS_YR4_RT': float, 'MD_INC_ENRL_ORIG_YR4_RT': float, 'MD_INC_ENRL_4YR_TRANS_YR4_RT': float, 'MD_INC_ENRL_2YR_TRANS_YR4_RT': float, 'MD_INC_UNKN_ORIG_YR4_RT': float, 'MD_INC_UNKN_4YR_TRANS_YR4_RT': float, 'MD_INC_UNKN_2YR_TRANS_YR4_RT': float, 'HI_INC_DEATH_YR4_RT': float, 'HI_INC_COMP_ORIG_YR4_RT': float, 'HI_INC_COMP_4YR_TRANS_YR4_RT': float, 'HI_INC_COMP_2YR_TRANS_YR4_RT': float, 'HI_INC_WDRAW_ORIG_YR4_RT': float, 'HI_INC_WDRAW_4YR_TRANS_YR4_RT': float, 'HI_INC_WDRAW_2YR_TRANS_YR4_RT': float, 'HI_INC_ENRL_ORIG_YR4_RT': float, 'HI_INC_ENRL_4YR_TRANS_YR4_RT': float, 'HI_INC_ENRL_2YR_TRANS_YR4_RT': float, 'HI_INC_UNKN_ORIG_YR4_RT': float, 'HI_INC_UNKN_4YR_TRANS_YR4_RT': float, 'HI_INC_UNKN_2YR_TRANS_YR4_RT': float, 'DEP_DEATH_YR4_RT': float, 'DEP_COMP_ORIG_YR4_RT': float, 'DEP_COMP_4YR_TRANS_YR4_RT': float, 'DEP_COMP_2YR_TRANS_YR4_RT': float, 'DEP_WDRAW_ORIG_YR4_RT': float, 'DEP_WDRAW_4YR_TRANS_YR4_RT': float, 'DEP_WDRAW_2YR_TRANS_YR4_RT': float, 'DEP_ENRL_ORIG_YR4_RT': float, 'DEP_ENRL_4YR_TRANS_YR4_RT': float, 'DEP_ENRL_2YR_TRANS_YR4_RT': float, 'DEP_UNKN_ORIG_YR4_RT': float, 'DEP_UNKN_4YR_TRANS_YR4_RT': float, 'DEP_UNKN_2YR_TRANS_YR4_RT': float, 'IND_DEATH_YR4_RT': float, 'IND_COMP_ORIG_YR4_RT': float, 'IND_COMP_4YR_TRANS_YR4_RT': float, 'IND_COMP_2YR_TRANS_YR4_RT': float, 'IND_WDRAW_ORIG_YR4_RT': float, 'IND_WDRAW_4YR_TRANS_YR4_RT': float, 'IND_WDRAW_2YR_TRANS_YR4_RT': float, 'IND_ENRL_ORIG_YR4_RT': float, 'IND_ENRL_4YR_TRANS_YR4_RT': float, 'IND_ENRL_2YR_TRANS_YR4_RT': float, 'IND_UNKN_ORIG_YR4_RT': float, 'IND_UNKN_4YR_TRANS_YR4_RT': float, 'IND_UNKN_2YR_TRANS_YR4_RT': float, 'FEMALE_DEATH_YR4_RT': float, 'FEMALE_COMP_ORIG_YR4_RT': float, 'FEMALE_COMP_4YR_TRANS_YR4_RT': float, 'FEMALE_COMP_2YR_TRANS_YR4_RT': float, 'FEMALE_WDRAW_ORIG_YR4_RT': float, 'FEMALE_WDRAW_4YR_TRANS_YR4_RT': float, 'FEMALE_WDRAW_2YR_TRANS_YR4_RT': float, 'FEMALE_ENRL_ORIG_YR4_RT': float, 'FEMALE_ENRL_4YR_TRANS_YR4_RT': float, 'FEMALE_ENRL_2YR_TRANS_YR4_RT': float, 'FEMALE_UNKN_ORIG_YR4_RT': float, 'FEMALE_UNKN_4YR_TRANS_YR4_RT': float, 'FEMALE_UNKN_2YR_TRANS_YR4_RT': float, 'MALE_DEATH_YR4_RT': float, 'MALE_COMP_ORIG_YR4_RT': float, 'MALE_COMP_4YR_TRANS_YR4_RT': float, 'MALE_COMP_2YR_TRANS_YR4_RT': float, 'MALE_WDRAW_ORIG_YR4_RT': float, 'MALE_WDRAW_4YR_TRANS_YR4_RT': float, 'MALE_WDRAW_2YR_TRANS_YR4_RT': float, 'MALE_ENRL_ORIG_YR4_RT': float, 'MALE_ENRL_4YR_TRANS_YR4_RT': float, 'MALE_ENRL_2YR_TRANS_YR4_RT': float, 'MALE_UNKN_ORIG_YR4_RT': float, 'MALE_UNKN_4YR_TRANS_YR4_RT': float, 'MALE_UNKN_2YR_TRANS_YR4_RT': float, 'PELL_DEATH_YR4_RT': float, 'PELL_COMP_ORIG_YR4_RT': float, 'PELL_COMP_4YR_TRANS_YR4_RT': float, 'PELL_COMP_2YR_TRANS_YR4_RT': float, 'PELL_WDRAW_ORIG_YR4_RT': float, 'PELL_WDRAW_4YR_TRANS_YR4_RT': float, 'PELL_WDRAW_2YR_TRANS_YR4_RT': float, 'PELL_ENRL_ORIG_YR4_RT': float, 'PELL_ENRL_4YR_TRANS_YR4_RT': float, 'PELL_ENRL_2YR_TRANS_YR4_RT': float, 'PELL_UNKN_ORIG_YR4_RT': float, 'PELL_UNKN_4YR_TRANS_YR4_RT': float, 'PELL_UNKN_2YR_TRANS_YR4_RT': float, 'NOPELL_DEATH_YR4_RT': float, 'NOPELL_COMP_ORIG_YR4_RT': float, 'NOPELL_COMP_4YR_TRANS_YR4_RT': float, 'NOPELL_COMP_2YR_TRANS_YR4_RT': float, 'NOPELL_WDRAW_ORIG_YR4_RT': float, 'NOPELL_WDRAW_4YR_TRANS_YR4_RT': float, 'NOPELL_WDRAW_2YR_TRANS_YR4_RT': float, 'NOPELL_ENRL_ORIG_YR4_RT': float, 'NOPELL_ENRL_4YR_TRANS_YR4_RT': float, 'NOPELL_ENRL_2YR_TRANS_YR4_RT': float, 'NOPELL_UNKN_ORIG_YR4_RT': float, 'NOPELL_UNKN_4YR_TRANS_YR4_RT': float, 'NOPELL_UNKN_2YR_TRANS_YR4_RT': float, 'FIRSTGEN_DEATH_YR4_RT': float, 'FIRSTGEN_COMP_ORIG_YR4_RT': float, 'FIRSTGEN_COMP_4YR_TRANS_YR4_RT': float, 'FIRSTGEN_COMP_2YR_TRANS_YR4_RT': float, 'FIRSTGEN_WDRAW_ORIG_YR4_RT': float, 'FIRSTGEN_WDRAW_4YR_TRANS_YR4_RT': float, 'FIRSTGEN_WDRAW_2YR_TRANS_YR4_RT': float, 'FIRSTGEN_ENRL_ORIG_YR4_RT': float, 'FIRSTGEN_ENRL_4YR_TRANS_YR4_RT': float, 'FIRSTGEN_ENRL_2YR_TRANS_YR4_RT': float, 'FIRSTGEN_UNKN_ORIG_YR4_RT': float, 'FIRSTGEN_UNKN_4YR_TRANS_YR4_RT': float, 'FIRSTGEN_UNKN_2YR_TRANS_YR4_RT': float, 'NOT1STGEN_DEATH_YR4_RT': float, 'NOT1STGEN_COMP_ORIG_YR4_RT': float, 'NOT1STGEN_COMP_4YR_TRANS_YR4_RT': float, 'NOT1STGEN_COMP_2YR_TRANS_YR4_RT': float, 'NOT1STGEN_WDRAW_ORIG_YR4_RT': float, 'NOT1STGEN_WDRAW_4YR_TRANS_YR4_RT': float, 'NOT1STGEN_WDRAW_2YR_TRANS_YR4_RT': float, 'NOT1STGEN_ENRL_ORIG_YR4_RT': float, 'NOT1STGEN_ENRL_4YR_TRANS_YR4_RT': float, 'NOT1STGEN_ENRL_2YR_TRANS_YR4_RT': float, 'NOT1STGEN_UNKN_ORIG_YR4_RT': float, 'NOT1STGEN_UNKN_4YR_TRANS_YR4_RT': float, 'NOT1STGEN_UNKN_2YR_TRANS_YR4_RT': float, 'DEATH_YR6_RT': float, 'COMP_ORIG_YR6_RT': float, 'COMP_4YR_TRANS_YR6_RT': float, 'COMP_2YR_TRANS_YR6_RT': float, 'WDRAW_ORIG_YR6_RT': float, 'WDRAW_4YR_TRANS_YR6_RT': float, 'WDRAW_2YR_TRANS_YR6_RT': float, 'ENRL_ORIG_YR6_RT': float, 'ENRL_4YR_TRANS_YR6_RT': float, 'ENRL_2YR_TRANS_YR6_RT': float, 'UNKN_ORIG_YR6_RT': float, 'UNKN_4YR_TRANS_YR6_RT': float, 'UNKN_2YR_TRANS_YR6_RT': float, 'LO_INC_DEATH_YR6_RT': float, 'LO_INC_COMP_ORIG_YR6_RT': float, 'LO_INC_COMP_4YR_TRANS_YR6_RT': float, 'LO_INC_COMP_2YR_TRANS_YR6_RT': float, 'LO_INC_WDRAW_ORIG_YR6_RT': float, 'LO_INC_WDRAW_4YR_TRANS_YR6_RT': float, 'LO_INC_WDRAW_2YR_TRANS_YR6_RT': float, 'LO_INC_ENRL_ORIG_YR6_RT': float, 'LO_INC_ENRL_4YR_TRANS_YR6_RT': float, 'LO_INC_ENRL_2YR_TRANS_YR6_RT': float, 'LO_INC_UNKN_ORIG_YR6_RT': float, 'LO_INC_UNKN_4YR_TRANS_YR6_RT': float, 'LO_INC_UNKN_2YR_TRANS_YR6_RT': float, 'MD_INC_DEATH_YR6_RT': float, 'MD_INC_COMP_ORIG_YR6_RT': float, 'MD_INC_COMP_4YR_TRANS_YR6_RT': float, 'MD_INC_COMP_2YR_TRANS_YR6_RT': float, 'MD_INC_WDRAW_ORIG_YR6_RT': float, 'MD_INC_WDRAW_4YR_TRANS_YR6_RT': float, 'MD_INC_WDRAW_2YR_TRANS_YR6_RT': float, 'MD_INC_ENRL_ORIG_YR6_RT': float, 'MD_INC_ENRL_4YR_TRANS_YR6_RT': float, 'MD_INC_ENRL_2YR_TRANS_YR6_RT': float, 'MD_INC_UNKN_ORIG_YR6_RT': float, 'MD_INC_UNKN_4YR_TRANS_YR6_RT': float, 'MD_INC_UNKN_2YR_TRANS_YR6_RT': float, 'HI_INC_DEATH_YR6_RT': float, 'HI_INC_COMP_ORIG_YR6_RT': float, 'HI_INC_COMP_4YR_TRANS_YR6_RT': float, 'HI_INC_COMP_2YR_TRANS_YR6_RT': float, 'HI_INC_WDRAW_ORIG_YR6_RT': float, 'HI_INC_WDRAW_4YR_TRANS_YR6_RT': float, 'HI_INC_WDRAW_2YR_TRANS_YR6_RT': float, 'HI_INC_ENRL_ORIG_YR6_RT': float, 'HI_INC_ENRL_4YR_TRANS_YR6_RT': float, 'HI_INC_ENRL_2YR_TRANS_YR6_RT': float, 'HI_INC_UNKN_ORIG_YR6_RT': float, 'HI_INC_UNKN_4YR_TRANS_YR6_RT': float, 'HI_INC_UNKN_2YR_TRANS_YR6_RT': float, 'DEP_DEATH_YR6_RT': float, 'DEP_COMP_ORIG_YR6_RT': float, 'DEP_COMP_4YR_TRANS_YR6_RT': float, 'DEP_COMP_2YR_TRANS_YR6_RT': float, 'DEP_WDRAW_ORIG_YR6_RT': float, 'DEP_WDRAW_4YR_TRANS_YR6_RT': float, 'DEP_WDRAW_2YR_TRANS_YR6_RT': float, 'DEP_ENRL_ORIG_YR6_RT': float, 'DEP_ENRL_4YR_TRANS_YR6_RT': float, 'DEP_ENRL_2YR_TRANS_YR6_RT': float, 'DEP_UNKN_ORIG_YR6_RT': float, 'DEP_UNKN_4YR_TRANS_YR6_RT': float, 'DEP_UNKN_2YR_TRANS_YR6_RT': float, 'IND_DEATH_YR6_RT': float, 'IND_COMP_ORIG_YR6_RT': float, 'IND_COMP_4YR_TRANS_YR6_RT': float, 'IND_COMP_2YR_TRANS_YR6_RT': float, 'IND_WDRAW_ORIG_YR6_RT': float, 'IND_WDRAW_4YR_TRANS_YR6_RT': float, 'IND_WDRAW_2YR_TRANS_YR6_RT': float, 'IND_ENRL_ORIG_YR6_RT': float, 'IND_ENRL_4YR_TRANS_YR6_RT': float, 'IND_ENRL_2YR_TRANS_YR6_RT': float, 'IND_UNKN_ORIG_YR6_RT': float, 'IND_UNKN_4YR_TRANS_YR6_RT': float, 'IND_UNKN_2YR_TRANS_YR6_RT': float, 'FEMALE_DEATH_YR6_RT': float, 'FEMALE_COMP_ORIG_YR6_RT': float, 'FEMALE_COMP_4YR_TRANS_YR6_RT': float, 'FEMALE_COMP_2YR_TRANS_YR6_RT': float, 'FEMALE_WDRAW_ORIG_YR6_RT': float, 'FEMALE_WDRAW_4YR_TRANS_YR6_RT': float, 'FEMALE_WDRAW_2YR_TRANS_YR6_RT': float, 'FEMALE_ENRL_ORIG_YR6_RT': float, 'FEMALE_ENRL_4YR_TRANS_YR6_RT': float, 'FEMALE_ENRL_2YR_TRANS_YR6_RT': float, 'FEMALE_UNKN_ORIG_YR6_RT': float, 'FEMALE_UNKN_4YR_TRANS_YR6_RT': float, 'FEMALE_UNKN_2YR_TRANS_YR6_RT': float, 'MALE_DEATH_YR6_RT': float, 'MALE_COMP_ORIG_YR6_RT': float, 'MALE_COMP_4YR_TRANS_YR6_RT': float, 'MALE_COMP_2YR_TRANS_YR6_RT': float, 'MALE_WDRAW_ORIG_YR6_RT': float, 'MALE_WDRAW_4YR_TRANS_YR6_RT': float, 'MALE_WDRAW_2YR_TRANS_YR6_RT': float, 'MALE_ENRL_ORIG_YR6_RT': float, 'MALE_ENRL_4YR_TRANS_YR6_RT': float, 'MALE_ENRL_2YR_TRANS_YR6_RT': float, 'MALE_UNKN_ORIG_YR6_RT': float, 'MALE_UNKN_4YR_TRANS_YR6_RT': float, 'MALE_UNKN_2YR_TRANS_YR6_RT': float, 'PELL_DEATH_YR6_RT': float, 'PELL_COMP_ORIG_YR6_RT': float, 'PELL_COMP_4YR_TRANS_YR6_RT': float, 'PELL_COMP_2YR_TRANS_YR6_RT': float, 'PELL_WDRAW_ORIG_YR6_RT': float, 'PELL_WDRAW_4YR_TRANS_YR6_RT': float, 'PELL_WDRAW_2YR_TRANS_YR6_RT': float, 'PELL_ENRL_ORIG_YR6_RT': float, 'PELL_ENRL_4YR_TRANS_YR6_RT': float, 'PELL_ENRL_2YR_TRANS_YR6_RT': float, 'PELL_UNKN_ORIG_YR6_RT': float, 'PELL_UNKN_4YR_TRANS_YR6_RT': float, 'PELL_UNKN_2YR_TRANS_YR6_RT': float, 'NOPELL_DEATH_YR6_RT': float, 'NOPELL_COMP_ORIG_YR6_RT': float, 'NOPELL_COMP_4YR_TRANS_YR6_RT': float, 'NOPELL_COMP_2YR_TRANS_YR6_RT': float, 'NOPELL_WDRAW_ORIG_YR6_RT': float, 'NOPELL_WDRAW_4YR_TRANS_YR6_RT': float, 'NOPELL_WDRAW_2YR_TRANS_YR6_RT': float, 'NOPELL_ENRL_ORIG_YR6_RT': float, 'NOPELL_ENRL_4YR_TRANS_YR6_RT': float, 'NOPELL_ENRL_2YR_TRANS_YR6_RT': float, 'NOPELL_UNKN_ORIG_YR6_RT': float, 'NOPELL_UNKN_4YR_TRANS_YR6_RT': float, 'NOPELL_UNKN_2YR_TRANS_YR6_RT': float, 'FIRSTGEN_DEATH_YR6_RT': float, 'FIRSTGEN_COMP_ORIG_YR6_RT': float, 'FIRSTGEN_COMP_4YR_TRANS_YR6_RT': float, 'FIRSTGEN_COMP_2YR_TRANS_YR6_RT': float, 'FIRSTGEN_WDRAW_ORIG_YR6_RT': float, 'FIRSTGEN_WDRAW_4YR_TRANS_YR6_RT': float, 'FIRSTGEN_WDRAW_2YR_TRANS_YR6_RT': float, 'FIRSTGEN_ENRL_ORIG_YR6_RT': float, 'FIRSTGEN_ENRL_4YR_TRANS_YR6_RT': float, 'FIRSTGEN_ENRL_2YR_TRANS_YR6_RT': float, 'FIRSTGEN_UNKN_ORIG_YR6_RT': float, 'FIRSTGEN_UNKN_4YR_TRANS_YR6_RT': float, 'FIRSTGEN_UNKN_2YR_TRANS_YR6_RT': float, 'NOT1STGEN_DEATH_YR6_RT': float, 'NOT1STGEN_COMP_ORIG_YR6_RT': float, 'NOT1STGEN_COMP_4YR_TRANS_YR6_RT': float, 'NOT1STGEN_COMP_2YR_TRANS_YR6_RT': float, 'NOT1STGEN_WDRAW_ORIG_YR6_RT': float, 'NOT1STGEN_WDRAW_4YR_TRANS_YR6_RT': float, 'NOT1STGEN_WDRAW_2YR_TRANS_YR6_RT': float, 'NOT1STGEN_ENRL_ORIG_YR6_RT': float, 'NOT1STGEN_ENRL_4YR_TRANS_YR6_RT': float, 'NOT1STGEN_ENRL_2YR_TRANS_YR6_RT': float, 'NOT1STGEN_UNKN_ORIG_YR6_RT': float, 'NOT1STGEN_UNKN_4YR_TRANS_YR6_RT': float, 'NOT1STGEN_UNKN_2YR_TRANS_YR6_RT': float, 'RPY_1YR_RT': float, 'COMPL_RPY_1YR_RT': float, 'NONCOM_RPY_1YR_RT': float, 'LO_INC_RPY_1YR_RT': float, 'MD_INC_RPY_1YR_RT': float, 'HI_INC_RPY_1YR_RT': float, 'DEP_RPY_1YR_RT': float, 'IND_RPY_1YR_RT': float, 'PELL_RPY_1YR_RT': float, 'NOPELL_RPY_1YR_RT': float, 'FEMALE_RPY_1YR_RT': float, 'MALE_RPY_1YR_RT': float, 'FIRSTGEN_RPY_1YR_RT': float, 'NOTFIRSTGEN_RPY_1YR_RT': float, 'RPY_3YR_RT': float, 'COMPL_RPY_3YR_RT': float, 'NONCOM_RPY_3YR_RT': float, 'LO_INC_RPY_3YR_RT': float, 'MD_INC_RPY_3YR_RT': float, 'HI_INC_RPY_3YR_RT': float, 'DEP_RPY_3YR_RT': float, 'IND_RPY_3YR_RT': float, 'PELL_RPY_3YR_RT': float, 'NOPELL_RPY_3YR_RT': float, 'FEMALE_RPY_3YR_RT': float, 'MALE_RPY_3YR_RT': float, 'FIRSTGEN_RPY_3YR_RT': float, 'NOTFIRSTGEN_RPY_3YR_RT': float, 'RPY_5YR_RT': float, 'COMPL_RPY_5YR_RT': float, 'NONCOM_RPY_5YR_RT': float, 'LO_INC_RPY_5YR_RT': float, 'MD_INC_RPY_5YR_RT': float, 'HI_INC_RPY_5YR_RT': float, 'DEP_RPY_5YR_RT': float, 'IND_RPY_5YR_RT': float, 'PELL_RPY_5YR_RT': float, 'NOPELL_RPY_5YR_RT': float, 'FEMALE_RPY_5YR_RT': float, 'MALE_RPY_5YR_RT': float, 'FIRSTGEN_RPY_5YR_RT': float, 'NOTFIRSTGEN_RPY_5YR_RT': float, 'RPY_7YR_RT': float, 'COMPL_RPY_7YR_RT': float, 'NONCOM_RPY_7YR_RT': float, 'LO_INC_RPY_7YR_RT': float, 'MD_INC_RPY_7YR_RT': float, 'HI_INC_RPY_7YR_RT': float, 'DEP_RPY_7YR_RT': float, 'IND_RPY_7YR_RT': float, 'PELL_RPY_7YR_RT': float, 'NOPELL_RPY_7YR_RT': float, 'FEMALE_RPY_7YR_RT': float, 'MALE_RPY_7YR_RT': float, 'FIRSTGEN_RPY_7YR_RT': float, 'NOTFIRSTGEN_RPY_7YR_RT': float, 'INC_PCT_LO': float, 'DEP_STAT_PCT_IND': float, 'DEP_INC_PCT_LO': float, 'IND_INC_PCT_LO': float, 'PAR_ED_PCT_1STGEN': float, 'INC_PCT_M1': float, 'INC_PCT_M2': float, 'INC_PCT_H1': float, 'INC_PCT_H2': float, 'DEP_INC_PCT_M1': float, 'DEP_INC_PCT_M2': float, 'DEP_INC_PCT_H1': float, 'DEP_INC_PCT_H2': float, 'IND_INC_PCT_M1': float, 'IND_INC_PCT_M2': float, 'IND_INC_PCT_H1': float, 'IND_INC_PCT_H2': float, 'PAR_ED_PCT_MS': float, 'PAR_ED_PCT_HS': float, 'PAR_ED_PCT_PS': float,
                                ...
                                'UGDS_MEN': float, 'UGDS_WOMEN': float, 'CDR3_DENOM': 'Int64', 'CDR2_DENOM': 'Int64', 'T4APPROVALDATE': str, 'OPENADMP': 'Int64', 'UGNONDS': 'Int64', 'GRADS': 'Int64', 'ACCREDCODE': str, 'RET_FT4_POOLED': float,
...
s3_bucket= "sample-bucket" # change the bucket name
profile_name= "sample-profile" # change the profile name
...
print("How long does it take to run this script:" , time.strftime("%H:%M:%S",time_to_run)) # 2.5 mins if write to parquet only, 6.5 mins if write both csv and parquet
